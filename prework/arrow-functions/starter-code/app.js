...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Let\'s do some math:', add(117, 102, 82));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Multi-line arrow function:', multiLiner('ollo'));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Hello from the old object function', oldObject(['hi', 'hello', 'are you there?', 'I\'m lost in the code!']));
...
// student info from the student constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
// undefined. 
// 3. Explain why "this" is different when an arrow function is used.
// the arrow function does not transfer the definition of the constructor.
